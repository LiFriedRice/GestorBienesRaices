                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control mt-2" id="priceMax" name="priceMax"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="sizeMin" name="sizeMin"
                                placeholder="Min Size">
                            <input type="number" class="form-control mt-2" id="sizeMax" name="sizeMax"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="acquisitionType" name="acquisitionType">
