...
<div class="container mt-5">
    ...
    <form id="contactForm" method="POST" action="{{ route('enviar.mensaje') }}">
        ...
        <input type="hidden" name="propiedadId" value="{{ $Usuario->propiedades->pluck('id_propiedad')->implode(', ') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="mensajePredeterminado" 
                value="Estoy interesado en la propiedad" readonly>
        </div>
